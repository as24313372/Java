...
class sg extends Thread{
	public boolean check = true,warn = false;
	public int countsg = 0,cy = 0,cx = 0;
	public int sgdir = 0;
	public int x,y,a,b;
	public int intmaze[][];
	...
	public void sgwalksavebox(){
		...
		switch(sgdir){
			case 0://down0
				if((intmaze[y+1][x] == 0)&&(y+1 != intmaze.length-2)){
					y+= 1;
					sgdir = 0;
				}
				else{
			...
			case 2://up2
				...
				break;
			case 3://right3
				if((intmaze[y][x+1] == 0)&&(x+1 != intmaze[0].length-2)){
					x+= 1;
					sgdir = 0;
				}
				else{
